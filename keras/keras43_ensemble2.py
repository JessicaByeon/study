...
x1_train, x1_test, x2_train, x2_test, x3_train, x3_test, y_train, y_test = train_test_split(x1, x2, x3, y, train_size=0.7, shuffle=True, random_state=66)
...
dense21 = Dense(16, activation='relu', name='jb21')(input2)
...
model.fit([x1_train, x2_train, x3_train], y_train, epochs=500, batch_size=100)
...
# loss : 7.8704633712768555
# r2 스코어 :  0.9909988292094145