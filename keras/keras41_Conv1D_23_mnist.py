# 기존 Conv2D 사용한 경우와 Conv1D 사용 시 성능비교 (23번~26번)

from tensorflow.python.keras.models import Sequential
from tensorflow.python.keras.layers import Dense, Conv1D, Flatten, MaxPooling1D, Dropout # 이미지 작업은 2D
...
model.add(Flatten()) # (N, 13*32) = (N, 416)
...
# Conv1D
# loss :  [0.15705102682113647, 0.9589999914169312]
# acc스코어 :  0.959