...
# + relu
# loss : [4.029910087585449, 0.8439560532569885]
# acc :  0.8844884634017944
# 당신에게 들려주고 싶은 이야기는 ['스스로 행복하다고 믿지 않으면, 그 누구도 행복할 수 없다. 푸블
# 릴리우스 시루스']
# project_01_0801_1658_0052-3.4247.hdf5

# loss : [2.984363555908203, 0.696703314781189]
# acc :  0.7458745837211609
# 당신에게 들려주고 싶은 이야기는 ['오늘을 붙들어라! 되도록 내일에 의지하지 말라! 그날 그날이 일년
#  중에서 최선의 날이다. 에머슨']
# project_01_0801_1704_0174-3.2911.hdf5

# loss : [4.598521709442139, 0.20659340918064117]
# acc :  0.33993399143218994
# 당신에게 들려주고 싶은 이야기는 ['돈을 잃는 것은 가벼운 손실이고 명예를 잃는 것은 중대한 손실이
# 다. 그러나 용기를 잃는 것은 보상 받을 수 없는 손실이다.']
# project_01_0801_1714_0012-5.0850.hdf5


# tanh / 훈련수 조절

# epochs=100, batch_size=100, patience=10
# loss : [2.4017910957336426, 0.8175824284553528]
# acc :  0.8778877854347229
# 당신에게 들려주고 싶은 이야기는 ['만남은 인연이다, 소중한 인연 소중하게 대하라.']
# project_01_0801_1724_0026-2.7537.hdf5


# epochs=300, batch_size=100, patience=100
# loss : [2.6153218746185303, 0.8461538553237915]
# acc :  0.8943894505500793
# 당신에게 들려주고 싶은 이야기는 ['모두가 이기는 것이 좋다는 말을 들어왔다. 하지만 나는 이렇게 말
# 하고 싶다. 지는 것도 좋다고. 윌터 휘트먼']
# project_01_0801_1730_0032-2.7060.hdf5

# loss : [2.311241626739502, 0.8505494594573975]
# acc :  0.9042904376983643
# 당신에게 들려주고 싶은 이야기는 ['노력은 성공을 가져다 주는 것은 아니지만, 나를 배신하지는 않을 
# 것이다.']
# project_01_0801_1734_0032-2.4526.hdf5


# epochs=500, batch_size=100, patience=200
# loss : [2.3053882122039795, 0.7890110015869141]
# acc :  0.8646864891052246
# 당신에게 들려주고 싶은 이야기는 ['짐을 덜어달라고 빌기보다는 강한 어깨를 달라고 기도하라. 어거스
# 턴']
# project_01_0801_1744_0024-2.7086.hdf5