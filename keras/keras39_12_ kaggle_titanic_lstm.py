...
print(x_train.shape, x_test.shape) # (801, 9) (90, 9)
print(y_train.shape, y_test.shape) # (801,) (90,)
x_train = x_train.reshape(801, 9, 1)
x_test = x_test.reshape(90, 9, 1)
print(x_train.shape, x_test.shape) # (801, 9, 1) (90, 9, 1)
...
print(y_test.shape, y_predict.shape) # (90,) (90, 1)
...
# LSTM
# loss : [0.6914384365081787, 0.6000000238418579]
# acc 스코어 :  0.6
