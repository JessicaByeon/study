...
# input1 = Input(shape=(10,)) # 먼저 input layer를 명시해줌
...
# model.save("./_save/keras23_save_model3_diabetes.h5")
model = load_model("./_save/keras23_save_model3_diabetes.h5")
...
# 함수형 모델 =================================================================
# RobustScaler
# loss :  2136.179931640625
# r2 스코어 :  0.6303903619843434
