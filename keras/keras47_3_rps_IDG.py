...
print(xy_train[0][0].shape, xy_train[0][1].shape) # (500, 150, 150, 3) (500, 3)
print(xy_test[0][0].shape, xy_test[0][1].shape) # (1, 150, 150, 3) (1, 1)

np.save('d:/study_data/_save/_npy/keras47_3_rps_x.npy', arr=xy_train[0][0])
np.save('d:/study_data/_save/_npy/keras47_3_rps_y.npy', arr=xy_train[0][1])
