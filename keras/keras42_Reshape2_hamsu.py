...
conv2d1 = Conv2D(kernel_size=(3,3), filters=64, padding='same')(input1)
maxp2d1 = MaxPooling2D()(conv2d1)
conv2d2 = Conv2D(kernel_size=(3,3), filters=32)(maxp2d1)
conv2d3 = Conv2D(kernel_size=(3,3), filters=7)(conv2d2)
flatten = Flatten()(conv2d3)
dense1 = Dense(100, activation='relu')(flatten)
reshape1 = Reshape(target_shape=(100,1))(dense1)
conv1d = Conv1D(10, 3)(reshape1)
lstm1 = LSTM(16)(conv1d)
