...
np.save('d:/study_data/_save/_npy/keras49_6_train_x.npy', arr=xy_train[0][0]) # train x 가 들어감
np.save('d:/study_data/_save/_npy/keras49_6_train_y.npy', arr=xy_train[0][1]) # train y 가 들어감
np.save('d:/study_data/_save/_npy/keras49_6_test_x.npy', arr=xy_test[0][0]) # test x 가 들어감
np.save('d:/study_data/_save/_npy/keras49_6_test_y.npy', arr=xy_test[0][1]) # test y 가 들어감
