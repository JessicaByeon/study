...
from sympy import zeros # 이미지데이터 생성, 증폭
...
x = np.load('d:/study_data/_save/_npy/keras47_4_men_women_train_x.npy')
y = np.load('d:/study_data/_save/_npy/keras47_4_men_women_train_y.npy')
z = np.load('d:/study_data/_save/_npy/keras47_4_men_women_train_z.npy')
...
earlyStopping = EarlyStopping(monitor='loss', patience=30, mode='auto', verbose=1, 
